...
const commentsData = [
  // comments for aeroforge-pro-75
  { productId: 'aeroforge-pro-75', user: 'Nguyễn Trần Minh', rating: 5, content: 'Bàn phím gõ siêu êm, âm thanh trầm ấm rất đã tai. Vỏ nhôm nặng trịch cực kỳ sang xịn mịn.', date: '2026-05-10' },
  { productId: 'aeroforge-pro-75', user: 'Hoàng Quốc Việt', rating: 5, content: 'Dùng kết nối 2.4Ghz cực nhạy không hề delay. Đóng gói cẩn thận, giao hàng siêu nhanh. Đáng tiền!', date: '2026-05-12' },
  { productId: 'aeroforge-pro-75', user: 'Khánh Linh', rating: 4, content: 'Phím rất đẹp nhưng hơi nặng khi bỏ balo mang đi làm. Cảm giác gõ thì 10/10.', date: '2026-05-15' },
  
  // comments for cyberboard-x-60
  { productId: 'cyberboard-x-60', user: 'Trần Gia Bảo', rating: 5, content: 'Led RGB cực kỳ sáng, gõ clicky sướng tai. Thiết kế nhỏ gọn giúp bàn làm việc rộng hẳn ra.', date: '2026-05-02' },
  { productId: 'cyberboard-x-60', user: 'Lê Minh Tuấn', rating: 4, content: 'Bàn phím đẹp, gõ thích. Tuy nhiên ai thích yên tĩnh thì nên cân nhắc vì switch clicky gõ ban đêm hơi ồn.', date: '2026-05-08' },
  
  // comments for retroclassic-tkl
  { productId: 'retroclassic-tkl', user: 'Phạm Hải Đăng', rating: 5, content: 'Thiết kế vintage quá hợp với góc setup làm việc của mình. Tiếng khấc khấc gõ văn bản rất sướng tay và không quá ồn.', date: '2026-05-01' },
  
  // comments for nomad-split-ergo
  { productId: 'nomad-split-ergo', user: 'Đỗ Tiến Đạt', rating: 5, content: 'Bàn phím công thái học gõ lúc đầu hơi lạ tay nhưng quen rồi thì không muốn quay lại phím thường luôn. Cực kỳ bảo vệ sức khỏe!', date: '2026-05-14' },
  
  // comments for aura-98-professional
  { productId: 'aura-98-professional', user: 'Lê Thùy Dương', rating: 5, content: 'Đúng là cứu cánh cho dân kế toán như mình. Đầy đủ phím số mà gõ lại cực kỳ êm ái không sợ ảnh hưởng đến đồng nghiệp xung quanh.', date: '2026-05-09' },
  { productId: 'aura-98-professional', user: 'Phạm Thế Hùng', rating: 4, content: 'Sản phẩm tốt, kết nối Bluetooth rất mượt mà. Tuy nhiên đèn nền led hơi mờ một chút so với bản custom nhôm.', date: '2026-05-11' },
  
  // comments for ghost-stealth-65
  { productId: 'ghost-stealth-65', user: 'Đinh Công Thành', rating: 5, content: 'Case nhôm đen nhám nhìn ngầu vô cùng, kết hợp góc setup đen tối giản là hết sảy. Rất tiếc hiện đang hết hàng để mua tặng thêm cho em trai.', date: '2026-05-15' }
];
...
async function seed() {
  try {
    ...
    console.log('--- Syncing Database models (Force: True to clean reset) ---');
    ...
    console.log(`Inserted ${promotionsData.length} promotions.`);
